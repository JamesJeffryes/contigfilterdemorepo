...
SERVICE_CAPS = bsadkhinContigFilterApplicationDemo
SPEC_FILE = bsadkhinContigFilterApplicationDemo.spec
URL = https://kbase.us/services/bsadkhincontigfilterapplicationdemo
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
