...
class bsadkhinContigFilterApplicationDemo(object):
    ...
    def filter_contigs(self, params, context=None):
        ...
        return self._client.call_method(
            'bsadkhinContigFilterApplicationDemo.filter_contigs',
            [params], self._service_ver, context)

    def status(self, context=None):
        return self._client.call_method('bsadkhinContigFilterApplicationDemo.status',
