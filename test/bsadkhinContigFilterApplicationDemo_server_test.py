...
from bsadkhinContigFilterApplicationDemo.bsadkhinContigFilterApplicationDemoImpl import bsadkhinContigFilterApplicationDemo
from bsadkhinContigFilterApplicationDemo.bsadkhinContigFilterApplicationDemoServer import MethodContext
from bsadkhinContigFilterApplicationDemo.authclient import KBaseAuth as _KBaseAuth

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class bsadkhinContigFilterApplicationDemoTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('bsadkhinContigFilterApplicationDemo'):
        ...
        cls.ctx.update({'token': token,
                        'user_id': user_id,
                        'provenance': [
                            {'service': 'bsadkhinContigFilterApplicationDemo',
        ...
        cls.serviceImpl = bsadkhinContigFilterApplicationDemo(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_bsadkhinContigFilterApplicationDemo_" + str(suffix)
